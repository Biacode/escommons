package org.biacode.escommons.core.repository.impl;
...
import org.biacode.escommons.core.repository.EsRepository;
...
public abstract class AbstractEsRepository<T extends AbstractEsDocument> implements EsRepository<T> {
    ...
    public DocumentsAndTotalCount<T> findByIds(@Nonnull final List<String> ids, @Nonnull final String indexName) {
        ...
        final SearchResponse searchResponse = esClient.prepareSearch(indexName)
                ...
                .setSize(DocumentConstants.FETCH_MAX_SIZE)
    ...
    protected String dateValue(@Nonnull final Object date) {
        ...
        return date instanceof Date ? DocumentConstants.DATE_FORMAT.format(date) : date.toString();
    }

    @Nonnull
    protected String dateTimeValue(@Nonnull final Object date) {
        Assert.notNull(date, "The date value should not be null");
        return date instanceof Date ? DocumentConstants.DATE_TIME_FORMAT.format(date) : date.toString();
    }
